# -*- coding: utf-8 -*-
"""
Created on Mon Sep 26 18:12:08 2016
...
#Use the One vs Rest (OVR) perceptron method
from sklearn.linear_model import Perceptron
ppn = Perceptron(n_iter=40, eta0=0.01, random_state=0)
ppn.fit(X_train_std, y_train)
y_pred = ppn.predict(X_test_std)

#Check the accuracy of the classificator
...
plt.savefig('DecisionRegion_Perceptron_Standardized.png')
